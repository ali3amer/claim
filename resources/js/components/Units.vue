                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group">
                                    <select v-model="city" @change="loadData()" class="form-control">
    ...
    methods: {
        getResults(page = 1) {
            if (this.city == 0) {
                ...
                axios.get('api/' + this.routeName + '?city=' + this.city + '&page=' + page)
                    .then(response => {
                        this.rows = response.data;
                    });
            }
        ...
        loadData() {
            if (this.city != 0) {
                axios.get('api/'+ this.routeName + '?city=' + this.city).then(({data}) => (this.rows = data));
            } else {
                axios.get('api/'+ this.routeName).then(({data}) => (this.rows = data));
            }
        },
