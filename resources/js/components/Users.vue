                ...
                <div class="modal-content">
                    <form @submit.prevent="editMode ? updateData() : createData()">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <select v-model="form.power" class="form-control">
                                    <option value="">إختر الصلاحيه .............</option>
                                    <option value="city">مسؤول محليه</option>
                                    <option value="dataEntry">مدخل بيانات</option>
                                    <option value="manger">مدير نظام</option>
                                </select>
                                <has-error :form="form" field="form.power"></has-error>
                            </div>

                            <div class="form-group" v-if="form.power == 'city'">
                                <select v-model="form.city_id" class="form-control">
                                    <option value="">إختر المحليه .............</option>
                                    <option v-for="city in cities" :value="city.id">{{ city.name }}</option>

                                </select>
                                <has-error :form="form" field="form.city_id"></has-error>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        editModal(row) {
            ...
            $("#" + this.modalTitle).modal('show');
            this.form.fill(row);
            this.form.city_id = row.powers.city_id;
    ...
    created() {
        ...
        axios.get('api/state?state=' + this.permissions.state_id).then(({data}) => (this.cities = data));
